...
<head>
  ...
  <title>Spirit's OS | Expiration Alerts</title>

  <link rel="stylesheet" href="../css/app-shell.css" />
  <link rel="stylesheet" href="../css/app-tools.css" />
  <link rel="stylesheet" href="../css/expiration-alerts.css" />
</head>
<body class="expiration-alerts-page">
  <div class="app-shell">
        ...
        <div class="sidebar-top">
          ...
          <nav class="sidebar-nav">
            <div class="nav-group">
              ...
              <a href="expiration-alerts.php" class="nav-item active" aria-current="page">
                <span class="nav-icon">
                  <svg viewBox="0 0 24 24" fill="none">
    ...
    <div class="main-shell">
            ...
            <div class="topbar-search" data-search-root>
              ...
              <div class="tool-dropdown search-panel" data-search-panel hidden>
                <div class="tool-panel-header">
                  <div>
                    <h3>Quick search</h3>
                    <p>Search alerts, disposal records, and FEFO actions.</p>
                  </div>
            ...
            <div class="topbar-notifications" data-notification-root>
              ...
              <div class="tool-dropdown notification-panel" data-notification-panel hidden>
                <div class="tool-panel-header">
                  <div>
                    <h3>Notifications</h3>
                    <p>Priority expiry alerts and disposal updates.</p>
                  </div>
      ...
      <main class="content-shell expiration-content">
        <section
          class="alerts-hero"
          id="expirationOverviewSection"
          data-search-title="Expiration Monitoring"
          data-search-description="Proactive safety tracking for batch traceability and FEFO compliance"
          data-search-keywords="expiration monitoring fefo expired near expiry disposal report"
        >
          <div class="alerts-hero__copy">
            <h1>Expiration Monitoring</h1>
            <p>Proactive safety tracking for batch traceability and FEFO compliance</p>
          </div>
          ...
          <div class="alerts-hero__actions">
            ...
            <button type="button" class="primary-btn" id="openDisposalHistoryBtn">
              <svg viewBox="0 0 24 24" fill="none">
        ...
        <section
          class="summary-grid"
          id="expirationSummarySection"
          data-search-title="Expiration Summary"
          data-search-description="Expired stock, near expiry, and safe inventory totals"
          data-search-keywords="expired stock near expiry safe inventory summary"
        >
          <article class="summary-card expired">
            ...
            <div class="summary-card__copy">
              ...
              <p>Immediate disposal required</p>
            </div>
          </article>

          <article class="summary-card near">
            <div class="summary-card__icon">
              <svg viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="8" stroke="currentColor" stroke-width="1.8"></circle>
                <path d="M12 8v4l2.5 1.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
            ...
            <div class="summary-card__copy">
              ...
              <strong id="nearExpiryCount">0</strong>
              <p>Next 60 days window</p>
            </div>
          </article>
          ...
          <article class="summary-card safe">
            <div class="summary-card__icon">
              <svg viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="8" stroke="currentColor" stroke-width="1.8"></circle>
                <path d="M8.5 12.5l2.2 2.2 4.8-5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </div>
            <div class="summary-card__copy">
              <span>Safe Inventory</span>
              <strong id="safeCount">0</strong>
        ...
        <section
          class="search-card"
          id="expirationSearchSection"
          data-search-title="Expiration Search"
          data-search-description="Search alerts by medicine, generic name, or batch number"
          data-search-keywords="search batch medicine generic expiry"
        >
          <label class="alert-search">
            <span class="alert-search__icon">
              <svg viewBox="0 0 24 24" fill="none">
        ...
        <section
          class="alerts-grid"
          id="expirationAlertTablesSection"
          data-search-title="Active Expiration Alerts"
          data-search-description="Expired and near-expiry batch tables"
          data-search-keywords="expired inventory near expiry tables batches"
        >
          <article class="alert-panel danger-panel">
            <header class="alert-panel__head">
              <div>
                <h3>Expired Inventory</h3>
                <p>Items that must be removed from shelves immediately.</p>
              </div>
          ...
          <article class="alert-panel warning-panel">
            <header class="alert-panel__head">
              <div>
                <h3>Near Expiry</h3>
                <p>Items expiring within the next 60 days.</p>
              </div>
              <span class="alert-panel__icon">
                <svg viewBox="0 0 24 24" fill="none">
        ...
        <section
          class="fefo-panel"
          id="fefoProtocolSection"
          data-search-title="FEFO Compliance Protocol"
          data-search-description="Safety score, FEFO guidelines, and inventory health status"
          data-search-keywords="fefo compliance safety score protocol"
        >
          <div class="fefo-panel__copy">
            <div class="fefo-icon">
              <svg viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.8"></circle>
                <path d="M12 10v5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
                <circle cx="12" cy="7.5" r=".8" fill="currentColor"></circle>
              </svg>
            </div>

            <h3>FEFO Compliance Protocol</h3>
            <p>
              Spirit's Drugstore strictly follows the First-Expired, First-Out (FEFO) protocol.
              Always prioritize selling batches with the nearest expiration date to minimize waste
              and ensure patient safety.
            </p>

            <div class="fefo-tags">
              <span>Daily Expiry Checks</span>
              <span>Automated POS Alerts</span>
            </div>
          </div>

          <div class="fefo-score-card">
            <span class="fefo-score-card__label">Safety Score</span>
            <strong id="safetyScoreText">0%</strong>

            <div class="score-bar">
              <span id="safetyScoreBar"></span>
            </div>

            <small id="safetyScoreNote">Inventory health summary</small>
          </div>
        </section>
      </main>
    </div>
  ...
  <div class="dialog-backdrop" id="detailsModal" hidden>
    <div class="dialog-card dialog-sm" role="dialog" aria-modal="true" aria-labelledby="detailsModalTitle">
      <div class="dialog-head">
        <div>
          <h3 id="detailsModalTitle">Batch Details</h3>
          <p>Complete information for the selected batch alert.</p>
        </div>
  ...
  <div class="dialog-backdrop" id="disposeModal" hidden>
    <div class="dialog-card dialog-sm" role="dialog" aria-modal="true" aria-labelledby="disposeModalTitle">
      <div class="dialog-head danger-head">
        <div>
          <h3 id="disposeModalTitle">Dispose Expired Batch</h3>
          <p>Record a disposal action without deleting the batch history.</p>
        </div>
        <button class="dialog-close" type="button" id="closeDisposeModalBtn" aria-label="Close">
          <svg viewBox="0 0 24 24" fill="none">
            <path d="M18 6L6 18" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
            <path d="M6 6L18 18" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
          </svg>
      ...
      <form id="disposeForm" class="dialog-form" novalidate>
        <div class="dialog-body">
          <div class="form-stack">
            <div class="detail-item">
              <span>Batch</span>
              <strong id="disposeBatchLabel">—</strong>
            </div>
            ...
            <label class="field">
              ...
              <input
                type="text"
                id="disposeReasonInput"
                placeholder="e.g. Expired stock removed from saleable inventory"
                maxlength="120"
                required
              />
            </label>
        ...
        <div class="dialog-foot">
          <button type="button" class="secondary-btn" id="cancelDisposeModalBtn">Cancel</button>
          <button type="submit" class="danger-btn">Confirm Disposal</button>
        </div>
      </form>
    </div>
  </div>

  <div class="dialog-backdrop" id="historyModal" hidden>
    <div class="dialog-card dialog-lg" role="dialog" aria-modal="true" aria-labelledby="historyModalTitle">
      <div class="dialog-head">
        <div>
          <h3 id="historyModalTitle">Disposal History</h3>
          <p>Logged disposal records for expired and removed inventory batches.</p>
        </div>
        <button class="dialog-close" type="button" id="closeHistoryModalBtn" aria-label="Close">
          <svg viewBox="0 0 24 24" fill="none">
            <path d="M18 6L6 18" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
            <path d="M6 6L18 18" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
          </svg>
      ...
      <div class="dialog-foot">
        <button type="button" class="secondary-btn" id="closeHistoryFooterBtn">Close</button>
      </div>
    </div>
  </div>
  ...
  <script src="../javascript/expiration-alerts.js" defer></script>
</body>
</html>